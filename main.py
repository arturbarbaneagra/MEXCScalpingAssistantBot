...
def health_check():
    ...
    try:
        ...
        modes_stats = telegram_bot.user_modes_manager.get_all_stats()
        
        user_modes_stats = {
            'total_users': user_stats.get('total_users', 0),
            'active_modes': modes_stats.get('total_users', 0)  # Пользователи с активными режимами
        }

        # Реальное число активных пользователей
        active_users = user_modes_stats.get('active_modes', 0)
